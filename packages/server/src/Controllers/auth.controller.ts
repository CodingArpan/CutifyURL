...
export default class authenticate {
    ...
    static login = async (req: Request, res: Response): Promise<Response> => {
        ...
        try {
            ...
            const user: (createprofile_temp & { _id: object; } & Omit<createprofile_temp, 'email' | 'mobile'>) | null = await userprofile.findOne({ email }).select<createprofile_temp>('fullname confirmpwd');
            console.log(user, '....')
