...
const AddFilterTags = () => {
  const [filtertags, setfiltertags] = useState<string[]>(["hello"]);
  ...
  return (
    <div>
      ...
      <div className="relative group px-2 py-1 bg-slate-300 rounded-lg w-max">
        ...
        <div className="icon invisible group-hover:visible absolute top-1 right-1 cursor-pointer bg-blue-400 rounded-full">
          <svg
            className="w-5"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
